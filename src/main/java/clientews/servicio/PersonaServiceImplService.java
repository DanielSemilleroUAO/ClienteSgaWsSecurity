 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://service.sga.daniel.com/", wsdlLocation = "http://localhost:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://service.sga.daniel.com/", "PersonaServiceImplService");
    ...
    public PersonaServiceWs getPersonaServiceImplPort() {
        return super.getPort(new QName("http://service.sga.daniel.com/", "PersonaServiceImplPort"), PersonaServiceWs.class);
    }
    ...
    public PersonaServiceWs getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.sga.daniel.com/", "PersonaServiceImplPort"), PersonaServiceWs.class, features);
    }
