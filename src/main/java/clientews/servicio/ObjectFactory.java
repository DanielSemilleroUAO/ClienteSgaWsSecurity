...
public class ObjectFactory {
    ...
    private final static QName _Persona_QNAME = new QName("http://servicio.sga.daniel.com/", "persona");
    private final static QName _ListarPersonas_QNAME = new QName("http://servicio.sga.daniel.com/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://servicio.sga.daniel.com/", "listarPersonasResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.daniel.com/", name = "persona")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.daniel.com/", name = "listarPersonas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.daniel.com/", name = "listarPersonasResponse")
